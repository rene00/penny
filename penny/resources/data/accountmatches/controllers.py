...
data_accountmatches = Blueprint(
    "data_accountmatches", __name__, url_prefix="/data/accountmatches"
)
...
def accountmatches():
    ...
    accountmatches = (
        ...
        .filter(models.AccountMatch.user_id == g.user.id)
        .order_by(models.Entity.name, models.AccountMatch.name)
    )
    ...
    if search:
        ...
        total = (
            models.db.session.query(models.AccountMatch.id)
